...
public class TestPromptTemplatesOllamaApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(PromptTemplatesOllamaApplication::main).with(TestPromptTemplatesOllamaApplication.class).run(args);
    }
